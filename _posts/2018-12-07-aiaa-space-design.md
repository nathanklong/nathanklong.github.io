---
layout: post
title: "Proposed Lunar Water-Ice Prospecting Mission"
date: 2018-12-07
...
<div class="banner-caption">Cis-Lunar Impactor</div>
</div>

<div class="banner-frame" markdown="0"
     margin: 0 auto;">
<img src="{{ site.url }}{{ site.baseurl }}/images/imact_orbiter_4.png"
     alt="imact_orbiter"
     loading="lazy"
     style="width: 100%; height: auto; display: block;">
...
## References
- [ASRC2018 Paper]({{ site.url }}{{ site.baseurl }}/papers/Nuss-Soeharto2018_-_Possible Near-Term Mission Architecture to Measure Lunar Polar Regolith Content.pdf)
- [RMIT Entry - Shackleton Prospector](https://aiaa.org/wp-content/uploads/2024/12/3rdplace_rmit_space_design-1.pdf)
- [AIAA Undergraduate Team Space Design Competition](https://aiaa.org/get-involved/university-students/design-competitions/2017-2018-design-competition-winning-reports/#space-design-competitio)
